        ...
        <div className="">
          ...
          <span className="block max-w-4xl text-balance space-y-8 pt-8">
            <p className="text-xl/8 text-muted-foreground leading-snug">
              ...
              loss of a loved one from suicide. The LifeLine App also provides
              awareness education and prevention strategies to guide people in
              crisis all across the Globe. The App was developed as a
              centralized hub to connect people with accredited resources in
